  ...
  const drawGraph = function () {
    ...
    switch (vizType) {
      ...
      case 'pie':
        ...
        if(fd.drill_through_url){
         let base_url= fd.drill_through_dashboard;
         console.log(fd.drill_through_dashboard);
        chart.pie.dispatch.on("elementClick", function(e) {
          console.log(fd.drill_through_dashboard);
          console.log(e.data);
          let url=base_url+'?preselect_filters={"85":{"gender":['+e.data['x']+']}}'
